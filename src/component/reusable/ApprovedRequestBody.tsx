...
import { APPROVED_DATA } from "../../utils/constant/ApprovedData";
import {getStatusColor, getTextColor} from "../../utils/func/ReusableFunctions";


const ApprovedRequestBody = () => {

  return (
    <div className="ml-4">   
      <div className="flex flex-shrink-0 justify-between w-5/6">
        <div className="request-style pt-2 mb-5">Approved Requests</div>
          <div>
            {/* <CalenderPicker /> */}
        </div>
      </div>
...
export default ApprovedRequestBody;