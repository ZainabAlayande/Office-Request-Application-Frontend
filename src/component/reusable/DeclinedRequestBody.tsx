...
import { DECLINED_DATA } from "../../utils/constant/DeclinedData";
import {getStatusColor, getTextColor} from "../../utils/func/ReusableFunctions";


const DeclinedRequestBody = () => {

  return (
    <div className="ml-4">   
      <div className="flex flex-shrink-0 justify-between w-5/6">
        <div className="request-style pt-2 mb-5">Declined Requests</div>
          <div>
            {/* <CalenderPicker /> */}
        </div>
      </div>
...
export default DeclinedRequestBody;